...
const CONTRACT_ADDRESS = import.meta.env.VITE_LICENSE_BOUNTY_ADDRESS || "0x0000000000000000000000000000000000000000";
...
function App() {
  ...
  const [form, setForm] = useState({ bountyId: "license-demo-001", title: "Open-source API bounty", developer: "", requirements: "Use an allowed permissive license, include attribution, and avoid prohibited dependency licenses.", allowed: "MIT\nApache-2.0\nBSD-3-Clause", prohibited: "GPL-3.0\nAGPL-3.0", attribution: true, copyleft: false, deadline: "", grace: "3600", challenge: "300", partial: "70", amount: "0.01" });
  const [submission, setSubmission] = useState({ bountyId: "license-demo-001", repo: "https://github.com/", commit: "", dependencyEvidence: "", attestation: "I confirm this exact commit is the work submitted for the bounty and the license information is complete." });
